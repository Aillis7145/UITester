...
/**
 * วิชาที่มี "การสอบวัดระดับ" จริง — หน้าเลือกวิชาสอบแสดงเฉพาะกลุ่มนี้
 *
 * ภาษาอังกฤษ CEFR กับภาษาจีน HSK เป็นการสอบเทียบระดับสากลที่มีข้อสอบของตัวเอง
 * ส่วนวิชาประถมวัดผลด้วยแบบทดสอบท้ายบทระหว่างเรียน ไม่มีการสอบทั้งคอร์ส
 * ถ้าเอาทั้ง 38 คอร์สมาเรียงในหน้าเลือกวิชาสอบ ผู้เรียนจะต้องไถผ่านของที่ไม่มีสิทธิ์สอบทั้งหน้า
 *
 * ประกาศที่นี่เพราะเป็นสมบัติของวิชา ไม่ใช่ของหน้าจอ —
 * หน้าจอที่ถือรายชื่อวิชาเองจะกลายเป็นที่ที่สองที่ต้องแก้ทุกครั้งที่เพิ่มวิชา
 */
export const EXAM_PROJECT_IDS = ['eng', 'zh'];
